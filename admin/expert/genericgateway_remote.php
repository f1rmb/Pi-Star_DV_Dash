...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" lang="en">
	...
	<div class="container">
		...
		$port = $_SESSION[''.$gateway.'Configs']['Remote Commands']['Port'];
		$command_msg = '';
		$message = '';
		...
		if (!empty($command)) {
			...
			$command_msg = ''.$gateway.' Status';
		    }
		    else if (strcmp($command, 'hosts') == 0) {
			$command_msg = ''.$gateway.' Hosts';
		    }
		...
		<table width="100%">
			...
			echo 'function executeGenericGatewayRemoteCommand(optStr){'."\n";
			echo '  $("#command_result").load("/admin/expert/genericgateway_remote_exec.php"+optStr);'."\n";
			echo '  setTimeout(function() { window.location="/admin/expert/index.php";}, ("'.$command.'" == "status" || "'.$command.'" == "hosts" ? 5000: 2000));'."\n";
			echo '}'."\n";
			echo 'setTimeout(executeGenericGatewayRemoteCommand, 100, "'.$command_url.'");'."\n";
