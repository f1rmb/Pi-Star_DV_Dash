	...
	<div class="container">
		...
		if (!empty($_POST)):
			...
			if (empty($_POST['autoapPsk']) != TRUE ) {
			    ...
			    echo "<table>\n";
			    echo "<tr><th>Done</th></tr>\n";
			    echo "<tr><td>WiFi Password Updated...</td><tr>\n";
			    echo "</table>\n";
			    unset($_POST);
			}
